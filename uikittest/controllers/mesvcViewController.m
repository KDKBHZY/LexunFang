...
//         self.collectionview.backgroundColor = [UIColor whiteColor];
    self.collectionview.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.07];
    ...
    if(indexPath.section == 0) {
        cell.backgroundColor = [UIColor whiteColor];
           //把不需要的view移除
             ...
             UIButton*btn = [[UIButton alloc] init];
                  [btn setImage:[UIImage imageNamed:@"mes1"] forState:UIControlStateNormal];
                 [cell addSubview:btn];
                 ...
                 UIButton*btn1 = [[UIButton alloc] init];
                         [btn1 setImage:[UIImage imageNamed:@"mes2"] forState:UIControlStateNormal];
             ...
             UIButton*btn2 = [[UIButton alloc] init];
                     [btn2 setImage:[UIImage imageNamed:@"mes3"] forState:UIControlStateNormal];
                 ...
                 UIButton*btn3 = [[UIButton alloc] init];
                         [btn3 setImage:[UIImage imageNamed:@"mes4"] forState:UIControlStateNormal];
        ...
        cell.backgroundColor = [UIColor whiteColor];
                  //把不需要的view移除
                    ...
                    [cell.namelabel removeFromSuperview];
                    [cell.gradelabel removeFromSuperview];
        MesTableView*tab = [[MesTableView alloc] initWithFrame:self.view.frame];
        [cell addSubview:tab];
    }
    return cell;
}
...
{
    if (indexPath.section == 0 ) {
            return CGSizeMake(UIScreen.mainScreen.bounds.size.width-40, 90);
...
{
    if (section == 0) {
            return UIEdgeInsetsMake(-10, 20.0, 10.0, 20.0);
